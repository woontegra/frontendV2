...
// Örnek testler
console.log(getAsgariUcretByDate("2014-03-15")); // 1071
console.log(getAsgariUcretByDate("2014-10-01")); // 1134
console.log(getAsgariUcretByDate("2025-01-01")); // 26005.50
console.log(getAsgariUcretByDate("2026-01-01")); // 33030.00
